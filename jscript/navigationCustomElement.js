class MyComponent extends HTMLElement {
	connectedCallback() {
		this.innerHTML = `<h2 class="">Deuteronomy-32</h2>
<button id="navbutton">&#9776;</button>

<ul id="nav" class="animated fadeOut" style="display: none;">
	<li><a href="index.html">HomeSweetHome</a></li>
...
customElements.define('my - navigation', MyComponent);
